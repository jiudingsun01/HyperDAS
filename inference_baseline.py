...
from hyperdas.data import get_ravel_collate_fn
from pyvene import (
    IntervenableConfig,
...
def run_experiment(
    ...
    def forward(
        base_input_ids: torch.LongTensor,
        base_attention_mask: torch.BoolTensor,
        base_intervention_position: torch.LongTensor,
        base_position_ids: Optional[torch.LongTensor] = None,
        source_input_ids: torch.LongTensor = None,
        source_attention_mask: torch.BoolTensor = None,
        source_intervention_position: torch.LongTensor = None,
