import torch
from .modules import Gemma2InterpretorConfig, Gemma2Interpretor
...
class RavelInterpretorHypernetwork(nn.Module):
    ...
    def __init__(
        self,
        model_name_or_path="/nlp/scr/sjd24/cache/hub/models--google--gemma-2-9b-it/snapshots/11c9b309abf73637e4b6f9a3fa1e92e615547819",
        ...
        self.interpretor_config = Gemma2InterpretorConfig.from_pretrained(model_name_or_path)
        ...
        self.interpretor = Gemma2Interpretor(
